...
---@return string|number multiple #(available since 2.1.7) returns 5 values:
...
---
--- **Since:** 2.0.8
---@param name string #(string) name of the field
...
function getFieldInfo(name) end
...
---@param source number|string #can be an identifier (number) (which was obtained by the getFieldInfo())
...
function playFile(name, path) end
...
function playTone(frequency, duration, pause, flags, freqIncr) end
